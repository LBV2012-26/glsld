...
#define iGrid           0      // 0:关, 1:黑体 2:固定色
#define iObserverMode   0      // 0:静态观者, 1:落体观者

#define iBlackHoleTime          (2.0*iTime)  // 使用 Shadertoy 时间
#define iBlackHoleMassSol       (1e7)     // 太阳质量倍数
#define iSpin                   0.99      // 自旋 必须与BufferB中iSpin一致！It must be modified synchronously with iSpin in BufferB！
#define iQ                      0.0      // 电荷

#define iMu                     1.0      // 吸积物质比荷
#define iAccretionRate          (5e-4)      // 吸积率

#define iInterRadiusRs          1.5      // 吸积盘内半径
#define iOuterRadiusRs          25.0     // 吸积盘外半径
#define iThinRs                 0.75     // 吸积盘半厚度
#define iHopper                 0.24      // 厚度斜率
#define iBrightmut              1.0      // 亮度
#define iDarkmut                0.5     // 不透明度
#define iReddening              0.3      // 红化
#define iSaturation             0.5      // 饱和度
#define iBlackbodyIntensityExponent 0.5
#define iRedShiftColorExponent      3.0
#define iRedShiftIntensityExponent  4.0

#define iPhotonRingBoost             7.0 //光子环亮度增亮
#define iPhotonRingColorTempBoost    2.0 //光子环颜色增蓝
#define iBoostRot                    0.75 //增强在自旋非0的非对称程度
...
#define iBlendWeight            0.5      //TAA前后帧混合权重
